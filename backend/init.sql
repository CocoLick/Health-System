...
CREATE TABLE IF NOT EXISTS dietitian (
    dietitian_id VARCHAR(20) PRIMARY KEY,
...
-- 插入测试规划师
INSERT INTO dietitian (dietitian_id, name, password, title, specialty, contact, created_at, updated_at, status)
VALUES ('D20260325001', '张医生', '$2a$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', '营养师', '临床营养', '13800138002', NOW(), NOW(), '启用');
